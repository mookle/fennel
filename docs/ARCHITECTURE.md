...
These rules bind every schema and every payload in the build, and this section is the source of truth for them. The set predates this build, carried over from the original spec, and ADR-0017, ADR-0018 and ADR-0019 have since decided three of the load-bearing ones that had no record.
