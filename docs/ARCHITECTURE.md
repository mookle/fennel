...
- **OrderSku**: the immutable crystallised snapshot of a SKU at the moment of submission. Nobody can edit it, and it has no status (ADR-0004). `docs/services/order.md` lists its fields.
